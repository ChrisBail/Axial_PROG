...
for event in Cat_events:
    ...
    if format_file=='nlloc':
        ...
        x_err=event.origins[0].longitude_errors.uncertainty
        y_err=event.origins[0].latitude_errors.uncertainty
        z_err=event.origins[0].depth_errors.uncertainty
